...
wget https://github.com/Ether1Project/Ether-1-GN-Binaries/releases/download/1.2.0/Ether1-MN-SN-1.2.0.tar.gz
...
ExecStart=/usr/sbin/geth --syncmode=fast --cache=512 --datadir=/home/$_user/.ether1 --lightserv 45 --lightpeers 100
